# Developing a ASP.NET Core app using Azure Cosmos DB for MongoDB API
...
* Then, clone this repository using `git clone git@github.com:lohithgn/azure-cosmos-db-mongodb-aspnetcore-getting-started.git`.

* Next, update appsettings.json. Find the section called `TasksDatabaseSettings`, substitute the `TasksCollectionName`, `ConnectionString`, and `DatbaseName`  with your Cosmos DB account's values. 
...
## About the code
The code included in this sample is intended to get you quickly started with a ASP.NET Core application that connects to Azure Cosmos DB for MongoDB API.
